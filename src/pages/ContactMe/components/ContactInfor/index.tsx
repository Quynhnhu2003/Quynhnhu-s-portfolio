...
function ContactInfor({ contactList }: { contactList: contactInforType[] }) {
  return (
    <AnimatedSection animationType="staggerContainer">
      <div className={styles.infor}>
        {contactList &&
          contactList.length > 0 &&
          contactList.map((contact: contactInforType, index: number) => (
            <AnimatedSection
              key={contact.id}
                ...
                <a
                  href={
                    contact.id === "contact01"
                      ? "https://www.google.com/maps/place/Phường+Tân+Thuận+Đông,+Quận+7,+TP.HCM"
                      : "tel:0706412609"
                  }
                  target="_blank"
